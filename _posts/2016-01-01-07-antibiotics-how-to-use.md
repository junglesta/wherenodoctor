...
Look up chloramphenicol in the GREEN PAGES (p. 356). You will find it must be used only for a few very serious illnesses, like typhoid, and is especially dangerous when given to the newborn.
